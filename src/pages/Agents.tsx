  ...
  return (
    <div className="page-container safe-top">
      ...
      <div className="px-6 mb-6">
        <div className="h-40 bg-secondary rounded-3xl flex items-center justify-center overflow-hidden relative">
      ...
      {/* Agent List */}
      <div className="px-6">
        <h2 className="text-lg font-bold text-foreground mb-4">Liste des agents</h2>
